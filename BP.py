...
class Ui_MainWindow(object):
    ...
    def showGraph(self):
        ...
        ax1.text(float(self.iptBP.text()), -0.1, float(self.iptBP.text()), color='red', ha='center')
        ...
        ax2.text(float(self.iptCholesterol.text()), -0.1, float(self.iptCholesterol.text()), color='red', ha='center')
        ...
        ax3.text(float(self.iptBloodSugar.text()), -0.1, float(self.iptBloodSugar.text()), color='red', ha='center')
        ...
        ax4.text(float(self.iptHDL.text()), -0.1, float(self.iptHDL.text()), color='red', ha='center')
        ...
        ax5.text(float(self.iptLDL.text()), -0.1, float(self.iptLDL.text()), color='red', ha='center')
        ...
        ax0.set_ylabel("Membership values")
        ax0.set_xlabel("Risk")
        ax0.set_title('Output of the Risk')
        ax0.legend()
        ...
        print("Heart Diagnosis:", defuzzified)
...
# Edited by ISMAIL MASSERAN
# Reference Code: Sevde-Kaskaya
